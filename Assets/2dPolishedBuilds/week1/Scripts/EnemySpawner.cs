...
//  data type  variable                any value  
    ...
    public void ForceSpawn() => Instantiate(enemyPrefab, spawnPos);
    ...
    public GameObject Spawning()
    {
        ...
        if(spawntimer <= 0)
        {
            ...
            spawntimer = Random.Range(0.25f,4);
        }
        
        //visualising
        //spawnTimerText.text = $"New enemy in: {_spawntimer}";
